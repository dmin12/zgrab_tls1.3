...
```
$ go get github.com/dmin12/zgrab_tls1.3
```

This will install zgrab under `$GOPATH/src/github.com/dmin12/zgrab_tls1.3`

```
$ cd $GOPATH/src/github.com/dmin12/zgrab_tls1.3
$ make
```
